...
class TestAASDirectoryEntry {
	...
	void testConstuctorParameterID() {
		...
		// Test object with empty ID and SubUnit
		...
		AASDirectoryEntry aasEntry4 = new AASDirectoryEntry("urn:FHG:iese:0.97:1", "<serializedAAS>", "local", "");
		// - Validate object
		...
		// Test object with ID, SubUnit, version and revision
		AASDirectoryEntry aasEntry5 = new AASDirectoryEntry("urn:FHG:iese:0.97:1:entity", "<serializedAAS>", "local", "");
		// - Validate object
		...
		// Test object with ID, SubUnit, version and revision
		AASDirectoryEntry aasEntry6 = new AASDirectoryEntry("urn:FHG:iese:0.97:1:entity#001", "<serializedAAS>", "local", "");
		// - Validate object
		...
		// Test object with ID, SubUnit, version and revision
		AASDirectoryEntry aasEntry7 = new AASDirectoryEntry("urn:FHG:iese:0.97:1:#001", "<serializedAAS>", "local", "");
		// - Validate object
	...
	void testConstuctorParameterContentAndContentType() {
		...
		AASDirectoryEntry aasEntry1 = new AASDirectoryEntry("urn:FHG:iese:0.97:1:#001", "<serializedAAS>", "local", "");
		// - Validate object
		...
		AASDirectoryEntry aasEntry2 = new AASDirectoryEntry("urn:FHG:iese:0.97:1:#001", "<serializedAAS>", "remote", "");
		// - Validate object
		...
		// Test object with remote content and without tags
		AASDirectoryEntry aasEntry3 = new AASDirectoryEntry("urn:FHG:iese:0.97:1:#001", "<serializedAAS>", "ReMote", "");
		// - Validate object
		...
		AASDirectoryEntry aasEntry4 = new AASDirectoryEntry("urn:FHG:iese:0.97:1:#001", "<serializedAAS>", "PROXY", "");
		// - Validate object
	...
	void testConstuctorParameterTags() {
		...
		AASDirectoryEntry aasEntry2 = new AASDirectoryEntry("urn:FHG:iese:0.97:1:#001", "<serializedAAS>", "local", "tag1");
		// - Validate object
		...
		// Test object with one tag
		AASDirectoryEntry aasEntry3 = new AASDirectoryEntry("urn:FHG:iese:0.97:1:#001", "<serializedAAS>", "local", "tag1,tag2");
		// - Validate object
