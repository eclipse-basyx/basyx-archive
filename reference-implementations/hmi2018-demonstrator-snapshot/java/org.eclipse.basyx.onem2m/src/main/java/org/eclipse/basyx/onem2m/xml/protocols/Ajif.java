 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ajir" type="{http://www.w3.org/2001/XMLSchema}anyURI"/&gt;
 *         &lt;choice minOccurs="0"&gt;
    ...
    extends FlexContainerResource
{
    ...
    protected List<Object> smdOrSubOrAjmd;
    ...
    /**
     * Gets the value of the smdOrSubOrAjmd property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the smdOrSubOrAjmd property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSmdOrSubOrAjmd().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getSmdOrSubOrAjmd() {
        if (smdOrSubOrAjmd == null) {
            smdOrSubOrAjmd = new ArrayList<Object>();
        }
        return this.smdOrSubOrAjmd;
    }
