 ...
 *             &lt;element ref="{http://www.onem2m.org/xml/protocols}ajmc"/&gt;
 *           &lt;/choice&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
    ...
    extends FlexContainerResource
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "ajmc", namespace = "http://www.onem2m.org/xml/protocols", type = Ajmc.class)
    })
    protected List<Object> smdOrSubOrAjmc;
    ...
    /**
     * Gets the value of the smdOrSubOrAjmc property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the smdOrSubOrAjmc property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSmdOrSubOrAjmc().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getSmdOrSubOrAjmc() {
        if (smdOrSubOrAjmc == null) {
            smdOrSubOrAjmc = new ArrayList<Object>();
        }
        return this.smdOrSubOrAjmc;
    }
