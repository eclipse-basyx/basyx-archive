    ...
    extends AnnouncedResource
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "smdA", namespace = "http://www.onem2m.org/xml/protocols", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "cinA", namespace = "http://www.onem2m.org/xml/protocols", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "cin", namespace = "http://www.onem2m.org/xml/protocols", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "cnt", namespace = "http://www.onem2m.org/xml/protocols", type = JAXBElement.class, required = false)
    })
    protected List<JAXBElement<?>> cinOrCinAOrCnt;
     ...
     * 
     */
    public List<JAXBElement<?>> getCinOrCinAOrCnt() {
        if (cinOrCinAOrCnt == null) {
            cinOrCinAOrCnt = new ArrayList<JAXBElement<?>>();
        }
