 ...
 *             &lt;element ref="{http://www.onem2m.org/xml/protocols}ajap"/&gt;
 *           &lt;/choice&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
    ...
    extends FlexContainerResource
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "ajap", namespace = "http://www.onem2m.org/xml/protocols", type = Ajap.class)
    })
    protected List<Object> smdOrSubOrAjap;
    ...
    /**
     * Gets the value of the smdOrSubOrAjap property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the smdOrSubOrAjap property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSmdOrSubOrAjap().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getSmdOrSubOrAjap() {
        if (smdOrSubOrAjap == null) {
            smdOrSubOrAjap = new ArrayList<Object>();
        }
        return this.smdOrSubOrAjap;
    }
