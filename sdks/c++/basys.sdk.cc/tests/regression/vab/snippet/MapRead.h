...
#define ASSERT_ANY_EQ(a,t) 	ASSERT_TRUE(a.InstanceOf<decltype(t)>());		ASSERT_EQ(t, a.Get<decltype(t)&>());
...
template<typename ModelProvider>
class MapRead {
public:
    ...
    static void test(ModelProvider & modelProvider) {
		// Test path access
