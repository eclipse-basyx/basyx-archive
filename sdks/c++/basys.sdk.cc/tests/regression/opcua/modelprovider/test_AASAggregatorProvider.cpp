    ...
    namespace tests
    {
        namespace opcua
        {
            ...
            public:
                ...
                std::unique_ptr<basyx::submodel::map::SubModel> sm_1;

                std::unique_ptr<basyx::submodel::map::SubModel> sm_2;
            ...
            {
                using namespace basyx::tests::opcua;
            ...
            basyx::object AAS()
            {
                ...
                aas->setAdministrativeInformation(basyx::submodel::map::AdministrativeInformation("1", "2"));
            ...
            basyx::object SM1()
            {
                ...
                /* Set Administration attributes */
                sm_1->setAdministrativeInformation(basyx::submodel::map::AdministrativeInformation("1", "2"));
                ...
                basyx::submodel::map::Reference toolReferences({ miscRef });
            ...
            basyx::object SM2()
            {
                ...
                sm_2->setAdministrativeInformation(basyx::submodel::map::AdministrativeInformation("1", "2"));
