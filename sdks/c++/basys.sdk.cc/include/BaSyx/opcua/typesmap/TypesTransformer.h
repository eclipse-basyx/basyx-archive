 ...
 * TypesTransformer.h
 *
 * Transforms basyx VAB types to OPCU-UA native types and vice versa. Since OPC-UA supports many types
 * than basyx VAB, the values non VAB types are represented as string in VAB with encapsualted meta-information.
 *
 *      Author: kannoth
 */
