    ...
    namespace opcua
    {
        namespace aas
        {
            ...
            inline std::string KindtoString(const Kind& t_kind) {
                return basyx::submodel::ModelingKind_::to_string(t_kind);
            }

            inline Kind KindfromString(const std::string& t_kindStr) {
                return basyx::submodel::ModelingKind_::from_string(t_kindStr);
            }

            inline std::string KeyElemementToString(KeyElements t_keyElement) {
                return basyx::submodel::KeyElements_::to_string(t_keyElement);
            }

            inline KeyElements KeyElemementFromString(const std::string& t_keyElementStr) {
                return basyx::submodel::KeyElements_::from_string(t_keyElementStr);
            }

            inline std::string KeyTypetoString(KeyType t_keyType) {
                return basyx::submodel::KeyType_::to_string(t_keyType);
            }

            inline KeyType KeyTypeFromString(const std::string& t_keyTypeStr) {
                return basyx::submodel::KeyType_::from_string(t_keyTypeStr);
            }
            ...
            inline IdentifierType IdTypefromString(const std::string& t_idTypeStr) {
                return basyx::submodel::IdentifierType_::from_string(t_idTypeStr);
            }
