        ...
        namespace aas
        {
            ...
            struct AASObjectDeserializer
            {
                ...
                static Identifier_t makeIdentifier(basyx::object t_object)
                {
                    ...
                    auto type{ basyx::submodel::IdentifierType_::from_string(typeStr) };
               ...
               static Key_t makeKey(const std::string& keyStr)
               {
                   ...
                   Key ret(basyx::submodel::KeyElements_::from_string(keyElement),
                       isLocalStr, basyx::submodel::KeyType_::from_string(keyType), keyVal);
                   return ret;
               }
