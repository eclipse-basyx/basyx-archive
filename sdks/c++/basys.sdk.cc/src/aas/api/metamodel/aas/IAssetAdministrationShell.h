...
public:
  ...
  virtual void addSubModel(const std::shared_ptr<ISubModel> subModel) = 0;
  ...
  virtual void setSubModel(const basyx::specificCollection_t<reference::IReference> submodels) const = 0;
  virtual basyx::specificCollection_t<reference::IReference> getSubModel() const = 0;
