...
ControlComponent::ControlComponent()
  : vab::ElementMap{}
  , savedOccupierId{""}
  , status_map{object::make_map()}
  , operations{object::make_map()}
{
  this->map.insertKey(constants_::to_string(constants::orderList), object::make_list<std::string>());

  //initialize status map
  this->map.insertKey(constants_::to_string(constants::status), this->status_map);
  this->insert_status(constants::exState, "");
...
basyx::object ControlComponent::getOrderList()
{
  return this->map.getProperty(constants_::to_string(constants::orderList));
}

void ControlComponent::addOrder(const std::string &newOrder)
{
  this->map.getProperty(constants_::to_string(constants::orderList)).insert(newOrder);
}
...
template<typename T>
void ControlComponent::insert_status(const ControlComponentConstants &status_key, T status)
{
...
template<typename T>
T ControlComponent::get_status(const basyx::controlcomponent::ControlComponentConstants & key)
{
...
object ControlComponent::init_service_operations()
{
  ...
  map.insertKey(constants_::to_string(constants::free), object::make_function([this](std::string senderId) {this->freeControlComponent(senderId); return true;}));
  map.insertKey(constants_::to_string(constants::occupy), object::make_function([this](std::string occupier) {this->occupyControlComponent(occupier); return true;}));
  map.insertKey(constants_::to_string(constants::priority), object::make_function([this](std::string occupier) {this->priorityOccupation(occupier); return true;}));

  map.insertKey(constants_::to_string(constants::Auto), object::make_function([this]() {this->setExecutionMode(ExecutionMode::Auto); return true;}));
  map.insertKey(constants_::to_string(constants::semiauto), object::make_function([this]() {this->setExecutionMode(ExecutionMode::Semiauto); return true;}));
  map.insertKey(constants_::to_string(constants::manual), object::make_function([this]() {this->setExecutionMode(ExecutionMode::Manual); return true;}));
  map.insertKey(constants_::to_string(constants::simulation), object::make_function([this]() {this->setExecutionMode(ExecutionMode::Simulation); return true;}));

  map.insertKey(constants_::to_string(constants::start), object::make_function([this]() {this->changeExecutionState(ExecutionOrder::start); return true;}));
  map.insertKey(constants_::to_string(constants::reset), object::make_function([this]() {this->changeExecutionState(ExecutionOrder::reset); return true;}));
  map.insertKey(constants_::to_string(constants::hold), object::make_function([this]() {this->changeExecutionState(ExecutionOrder::hold); return true;}));
  map.insertKey(constants_::to_string(constants::unhold), object::make_function([this]() {this->changeExecutionState(ExecutionOrder::unhold); return true;}));
  map.insertKey(constants_::to_string(constants::suspend), object::make_function([this]() {this->changeExecutionState(ExecutionOrder::suspend); return true;}));
  map.insertKey(constants_::to_string(constants::unsuspend), object::make_function([this]() {this->changeExecutionState(ExecutionOrder::unsuspend); return true;}));
  map.insertKey(constants_::to_string(constants::abort), object::make_function([this]() {this->changeExecutionState(ExecutionOrder::abort); return true;}));
  map.insertKey(constants_::to_string(constants::stop), object::make_function([this]() {this->changeExecutionState(ExecutionOrder::stop); return true;}));
  map.insertKey(constants_::to_string(constants::clear), object::make_function([this]() {this->changeExecutionState(ExecutionOrder::clear); return true;}));

  map.insertKey(constants_::to_string(constants::bstate), object::make_function([this] () {this->setOperationMode(std::string{"BSTATE"}); return true;}));
