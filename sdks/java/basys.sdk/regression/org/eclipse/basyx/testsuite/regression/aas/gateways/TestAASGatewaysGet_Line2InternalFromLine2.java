 ...
 *
 */
class TestAASGatewaysGet_Line2InternalFromLine2 {
	

	/**
	 * Store HTTP asset administration shell manager backend for office.iese.fraunhofer.de
	 */
	protected ConnectedAssetAdministrationShellManager aasManager = new ConnectedAssetAdministrationShellManager(new GatewayTestsuiteDirectoryLine2IESE(), new HTTPConnectorProvider());
