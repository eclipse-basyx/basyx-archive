 ...
 *
 */
public class SimpleVABElementServlet extends VABHTTPInterface<VABMultiSubmodelProvider> {
	...
	public SimpleVABElementServlet() {
		...
		this.getModelProvider().addProvider("SimpleVABElement", new SimpleVABElement());
	}
}
