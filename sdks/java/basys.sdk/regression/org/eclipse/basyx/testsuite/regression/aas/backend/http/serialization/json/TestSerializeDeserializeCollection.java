...
public class TestSerializeDeserializeCollection {
	...
	void test() {		Collection<Integer> integers1   = new HashSet<>();
	...
	Map<String, Object> serVal2 = GSONTools.Instance.serialize(integers2); // "int2",
	...
	Collection<Integer> integerColl1 = (Collection<Integer>) GSONTools.Instance.deserialize(serVal1);
	Collection<Integer> integerColl2 = (Collection<Integer>) GSONTools.Instance.deserialize(serVal2);
	Collection<Object>  objectColl1  = (Collection<Object>)  GSONTools.Instance.deserialize(serVal3);
