...
//		assertTrue(
//				aas1ChildrenA.getJSONObject("children").getJSONObject("sampleProperty1").get("aas").equals("Stub1AAS"));
//		assertTrue(aas1ChildrenA.getJSONObject("children").getJSONObject("sampleProperty1").get("submodel")
//				.equals("statusSM"));
//		assertTrue(aas1ChildrenA.getJSONObject("children").getJSONObject("sampleProperty1").get("path")
//				.equals("sampleProperty1"));
//		assertTrue(aas1ChildrenA.getJSONObject("children").getJSONObject("sampleProperty2").get("type").equals("ref"));
//		assertTrue(
//				aas1ChildrenA.getJSONObject("children").getJSONObject("sampleProperty2").get("aas").equals("Stub1AAS"));
//		assertTrue(aas1ChildrenA.getJSONObject("children").getJSONObject("sampleProperty2").get("submodel")
//				.equals("statusSM"));
//		assertTrue(aas1ChildrenA.getJSONObject("children").getJSONObject("sampleProperty2").get("path")
//				.equals("sampleProperty2"));
//		assertTrue(aas1ChildrenA.getJSONObject("children").getJSONObject("sampleProperty3").get("type").equals("ref"));
//		assertTrue(
//				aas1ChildrenA.getJSONObject("children").getJSONObject("sampleProperty3").get("aas").equals("Stub1AAS"));
//		assertTrue(aas1ChildrenA.getJSONObject("children").getJSONObject("sampleProperty3").get("submodel")
//				.equals("statusSM"));
//		assertTrue(aas1ChildrenA.getJSONObject("children").getJSONObject("sampleProperty3").get("path")
...
//		assertTrue(
//				aas1ChildrenB.getJSONObject("statusSM").getJSONObject("sampleProperty1").get("aas").equals("Stub1AAS"));
//		assertTrue(aas1ChildrenB.getJSONObject("statusSM").getJSONObject("sampleProperty1").get("submodel")
//				.equals("statusSM"));
//		assertTrue(aas1ChildrenB.getJSONObject("statusSM").getJSONObject("sampleProperty1").get("path")
//				.equals("sampleProperty1"));
//		assertTrue(aas1ChildrenB.getJSONObject("statusSM").getJSONObject("sampleProperty2").get("type").equals("ref"));
//		assertTrue(
//				aas1ChildrenB.getJSONObject("statusSM").getJSONObject("sampleProperty2").get("aas").equals("Stub1AAS"));
//		assertTrue(aas1ChildrenB.getJSONObject("statusSM").getJSONObject("sampleProperty2").get("submodel")
//				.equals("statusSM"));
//		assertTrue(aas1ChildrenB.getJSONObject("statusSM").getJSONObject("sampleProperty2").get("path")
//				.equals("sampleProperty2"));
//		assertTrue(aas1ChildrenB.getJSONObject("statusSM").getJSONObject("sampleProperty3").get("type").equals("ref"));
//		assertTrue(
//				aas1ChildrenB.getJSONObject("statusSM").getJSONObject("sampleProperty3").get("aas").equals("Stub1AAS"));
//		assertTrue(aas1ChildrenB.getJSONObject("statusSM").getJSONObject("sampleProperty3").get("submodel")
//				.equals("statusSM"));
//		assertTrue(aas1ChildrenB.getJSONObject("statusSM").getJSONObject("sampleProperty3").get("path")
//				.equals("sampleProperty3"));
...
//		assertTrue(
//				statusSMChildren.getJSONObject("children").getJSONObject("sampleProperty1").get("type").equals("ref"));
//		assertTrue(statusSMChildren.getJSONObject("children").getJSONObject("sampleProperty1").get("aas")
//				.equals("Stub1AAS"));
//		assertTrue(statusSMChildren.getJSONObject("children").getJSONObject("sampleProperty1").get("submodel")
//				.equals("statusSM"));
//		assertTrue(statusSMChildren.getJSONObject("children").getJSONObject("sampleProperty1").get("path")
//				.equals("sampleProperty1"));
//		assertTrue(
//				statusSMChildren.getJSONObject("children").getJSONObject("sampleProperty2").get("type").equals("ref"));
//		assertTrue(statusSMChildren.getJSONObject("children").getJSONObject("sampleProperty2").get("aas")
//				.equals("Stub1AAS"));
//		assertTrue(statusSMChildren.getJSONObject("children").getJSONObject("sampleProperty2").get("submodel")
//				.equals("statusSM"));
//		assertTrue(statusSMChildren.getJSONObject("children").getJSONObject("sampleProperty2").get("path")
//				.equals("sampleProperty2"));
//		assertTrue(
//				statusSMChildren.getJSONObject("children").getJSONObject("sampleProperty3").get("type").equals("ref"));
//		assertTrue(statusSMChildren.getJSONObject("children").getJSONObject("sampleProperty3").get("aas")
//				.equals("Stub1AAS"));
//		assertTrue(statusSMChildren.getJSONObject("children").getJSONObject("sampleProperty3").get("submodel")
//				.equals("statusSM"));
//		assertTrue(statusSMChildren.getJSONObject("children").getJSONObject("sampleProperty3").get("path")
//				.equals("sampleProperty3"));
