...
public class VABHTTPInterface<T extends IModelProvider> extends BasysHTTPServelet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String scope  = providerBackend.getElementScope(path); // we don't need this for sending back
		...
		// Serialize value
		returnValue = JSONTools.Instance.serialize(result, scope);
	...
	protected  Object extractParameter(String path, String serializedJSONValue, PrintWriter outputStream) {
		...
		// Null pointer check
		if ((serializedJSONValue == null) || (serializedJSONValue.trim().length() == 0)) return null;
