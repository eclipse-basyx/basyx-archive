 ...
 * 
 * This simple class neither supports frozen models nor clocks
 * 
 * @author kuhn
 *
 */
public class SimpleJSONProvider<T extends IModelProvider> {
	 ...
	 * Constructor
	 */
	public SimpleJSONProvider(T modelProviderBackend) {
	...
	public void processBaSysCreate(String path, String serializedJSONValue, PrintWriter outputStream) {
		...
		System.out.println("-------------------------- DO POST "+path+" => " + parameter +" ---------------------------------------------------------");
