...
public final class NodeId {
	 ...
	 * 
	 * <p>Numeric node ids technically use an unsigned 32 bit integer type. Since that type doesn't
	 * exist in Java, this method accepts a long, instead. The identifier is, however, not allowed 
	 * to be negative.
	 * 
	...
	public NodeId(int namespaceIndex, long identifier) {
		...
		this.internalId = new org.eclipse.milo.opcua.stack.core.types.builtin.NodeId(namespaceIndex, UInteger.valueOf(identifier));
	}
	 ...
	 * 
	 * <p>ByteString is a special OPC UA type that loosely corresponds to a Java array of bytes.
	 * 
	 * @param namespaceIndex The index of the node's namespace.
	...
	public NodeId(int namespaceIndex, byte[] identifier) {
		...
		this.internalId = new org.eclipse.milo.opcua.stack.core.types.builtin.NodeId(namespaceIndex, ByteString.of(identifier));
	}
	...
	/**
	 * Creates a node id from a string representation in the standard string format 
	 * (e.g. <code>ns=1;i=1234</code>).
	 * 
	 * <p>For a variant of this method which doesn't throw exceptions, see 
	 ...
	 * (e.g. <code>ns=1;i=1234</code>).
	 * 
	 * <p>This method is similar to {@link #parse(String)} but returns <code>null</code> instead of
	 ...
	 * 
	 * <p>The returned type depends on the type of the node id.
	 * <ul>
	 ...
	 * 
	 * <p>The returned string is formatted according to the machine-parseable formatting rules
	 * outlined in 
