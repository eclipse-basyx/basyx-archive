...
public final class ClientConfiguration implements Cloneable {
	 ...
	 * 
	 * <p>Default: <code>null</code> (i.e., no client certificate is used).
	 * 
	 ...
	 * 
	 * <p>Default: No certificate is used.
	 * 
	 ...
	 * 
	 * @throws IllegalArgumentException if keyPair is <code>null</code> but certificate is not or 
	 * 									vice versa.
	 */
	 ...
	 * 
	 * <p>Along with {@link #getMessageSecurityMode()} this parameter controls the endpoint
	 * selection when connecting to a server.
	 * 
	 * <p><b>Default:</b> {@link SecurityPolicy#None}.
	 ...
	 * 
	 * <p>Along with {@link #setMessageSecurityMode(MessageSecurityMode)} this parameter controls 
	 * the endpoint selection when connecting to a server.
	 * 
	 * <p><b>Default:</b> {@link SecurityPolicy#None}.
	 * 
	 ...
	 * 
	 * <p>Along with {@link #getSecurityPolicy()} this parameter controls the endpoint
	 * selection when connecting to a server.
	 * 
	 * <p>Default: {@link MessageSecurityMode#None}.
	 ...
	 * Sets the message security mode.
	 * 
	 * <p>Along with {@link #setSecurityPolicy(SecurityPolicy)} this parameter controls the endpoint
	 * selection when connecting to a server.
	 * 
	 * <p>Default: {@link MessageSecurityMode#None}.
	 * 
	 ...
	 * 
	 * <p>The client uses this name to identify itself towards the server. It needs not follow
	 * any specific format.
	 * 
	 ...
	 * 
	 * <p>The client uses this URI to identify itself towards the server.
	 * 
