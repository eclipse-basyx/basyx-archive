...
public class CertificateHelper {
	 ...
	 * 
	 * <p>This constructor generates a new RSA-2048 key pair used for signing the certificate.
	 * That's why it might take an appreciable amount of time to return.
	 */
	 ...
	 * 
	 * <p>If you're adding an IP address to the certificate as well, you can use 
	 * {@link #addIpAddress(InetAddress, boolean)} to add the associated host name
	 * automatically, without manually calling this method. However, see that method's 
	 * documentation for important limitations.
	 * 
	 ...
	 * 
	 * <p>Optionally, this method can also attempt to lookup the matching host name in the 
	 * background. If successful, the name will be added to the certificate.
	 * <br>If the lookup fails or doesn't finish until {@link #build()} is called, the
	 * name won't be added.
	 * <br>To guarantee the host name is added use {@link #addDnsName(String)}, instead.
	 * 
	 * @param ipAddress The address to add.
	 * @param lookupHostName If true, the host name will be looked up in the background 
	 * 		and added to the certificate.
	 * @return This {@link CertificateHelper}.
	 */
	 ...
	 * 
	 * <p>If no information has been provided, a default certificate is generated automatically.
	 * The default certificate carries only the common name <code>CN=Unknown</code>.
	 * 
	 * <p>After this method returns, the certificate can be acquired through 
	 * {@link #getCertificate()}.
	 * 
	...
	private SelfSignedCertificateBuilder configureBuilderWithInfo() throws CertificateException {
		SelfSignedCertificateBuilder builder = new SelfSignedCertificateBuilder(keyPair)
                ...
                .setOrganizationalUnit(this.organizationalUnit)
                .setLocalityName(this.locality)
                .setStateName(this.state)
