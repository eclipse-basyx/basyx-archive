...
public class OpcUaConnectorFactory extends ConnectorFactory {
	 ...
	 * 
	 * <p>Note, that the configuration is copied internally, so changes made to the object after
	 * creating the factory do not apply to connectors created by it.
	 * 
	 ...
	 * 
	 * <p>If a default configuration has been set, it will be applied to the connector before
	 * it is returned.
	 * 
