 ...
 *  
 * <p>While it is perfectly valid in OPC UA to have browse paths which match more than one single
 * node, BaSyx doesn't deal well with these cases. That's why this exception is thrown whenever 
 * such a browse path is encountered.
 */
