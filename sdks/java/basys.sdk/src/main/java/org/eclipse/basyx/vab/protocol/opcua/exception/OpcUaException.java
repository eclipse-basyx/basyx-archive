 ...
 * 
 * <p>User code can catch this exception type to handle all OPC UA related exceptions uniformly.
 * If more fine-grained handling of different failure modes is required, calling code must inspect
 * the cause through {@link #getCause()} and deal with exception types of the underlying library.
 */
