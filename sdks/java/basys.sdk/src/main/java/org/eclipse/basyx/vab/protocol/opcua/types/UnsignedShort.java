...
public final class UnsignedShort {	
	 ...
	 * @throws NumberFormatException if the value is outside the allowed range of {@link #MIN_VALUE}
	 * 								 to {@link #MAX_VALUE}.
	 */
	...
	/**
	 * Creates a new instance with the given internal value. Client code should normally not need
	 * to use this.
	 * 
	 ...
	 * @throws NumberFormatException if the result is outside the allowed range of 
	 * 								 {@link #MIN_VALUE} to {@link #MAX_VALUE}.
	 */
	public UnsignedShort add(UnsignedShort other) throws NumberFormatException {
		return new UnsignedShort(this.value.add(other.toShort()));
	}
	...
	public UnsignedShort add(short other) throws NumberFormatException {
		return new UnsignedShort(this.value.add(other));
	}
	...
	public UnsignedShort subtract(UnsignedShort other) throws NumberFormatException {
		return new UnsignedShort(this.value.subtract(other.toShort()));
	}
	...
	public UnsignedShort subtract(short other) throws NumberFormatException {
		return new UnsignedShort(this.value.subtract(other));
	}
	 ...
	 * 
	 * <p>The returned value is signed. Calling code needs to take care to stick to unsigned 
	 * semantics when dealing with it.
	 * 
