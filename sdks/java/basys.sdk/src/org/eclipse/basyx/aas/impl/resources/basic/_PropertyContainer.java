...
import org.eclipse.basyx.aas.api.resources.IElementContainer;
 ...
 *
 */
public class _PropertyContainer extends _Property implements IElementContainer, IContainerProperty {
	...
	public _PropertyContainer() {
		super();
		propertyType = PropertyType.Container;
	}
