package org.eclipse.basyx.vab.tools;
...
public class VABPathTools {
	...
	public static String buildPath(String[] pathElements, int startIndex) {
		...
		// Build path
		for (int i=startIndex; i<pathElements.length; i++) result.append(pathElements[i]+"/");
	...
	public static boolean isOperationPath(String path) {
		...
		if (pathElements[4].equals("operations")) return true;
