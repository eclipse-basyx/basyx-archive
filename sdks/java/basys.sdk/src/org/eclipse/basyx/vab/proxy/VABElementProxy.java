package org.eclipse.basyx.vab.proxy;

import org.eclipse.basyx.aas.api.exception.ServerException;
import org.eclipse.basyx.aas.api.services.IModelProvider;
import org.eclipse.basyx.vab.VABConnectionManager;
import org.eclipse.basyx.vab.type.VABTypes;
...
public class VABElementProxy {
	...
	/**
	 * Connection manager that enables resolving of references
	 */
	 ...
	 */
	public VABElementProxy(String addr, IModelProvider provider, VABConnectionManager connectionManager) {
		// Store references
		this.addr              = addr;
