 ...
 *
 */
public class SubmodelTemplateIRDISemantics extends SubmodelTemplate {
	 ...
	 */
	public SubmodelTemplateIRDISemantics() {
		// Create sub model
	 ...
	 */
	public SubmodelTemplateIRDISemantics(String semanticsIRDI, int idType, String id, String idShort, String category, String description, String qualifier, String version, String revision) {
		// Create sub model
		submodelData = new Submodel(
	 ...
	 * @param revision      Sub model revision
	 */
	public SubmodelTemplateIRDISemantics(String semanticsIRDI, int idType, String id, String idShort, String category, String description, Collection<String> qualifier, String version, String revision) {
		// Create sub model
		submodelData = new Submodel(
					new HasSemantics(new Identification(Identification.IRDI, semanticsIRDI)),
					new Identifiable(version, revision, idShort, category, description, idType, id),
