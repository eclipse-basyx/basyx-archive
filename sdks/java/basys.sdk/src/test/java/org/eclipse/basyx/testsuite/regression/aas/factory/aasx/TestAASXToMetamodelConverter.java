 ...
 *
 */
public class TestAASXToMetamodelConverter {
	/**
	 * path to the aasx package
	 */
	private static final String aasxPath = "src/test/resources/aas/factory/aasx/01_Festo.aasx";
	...
	public static void setup() throws IOException {
		...
		packageConverter = new AASXToMetamodelConverter(aasxPath);
	}
	...
	public void testLoadGeneratedAASX() throws InvalidFormatException, IOException, ParserConfigurationException, SAXException, TransformerException, URISyntaxException {
		...
		AASXToMetamodelConverter packageManager = new AASXToMetamodelConverter(CREATED_AASX_PATH);
